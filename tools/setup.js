...
GLOBAL.DATA_DIR =
  process.env.DATA_DIR || (GLOBAL.SERVER_ROOT + '/../' + sparseConfig.datadir);
GLOBAL.CDN_DIR =
  process.env.CDN_DIR || (GLOBAL.SERVER_ROOT + '/../' + sparseConfig.cdn);
...
function createDataDirs() {
  ...
  fs.mkdir(path.join(GLOBAL.DATA_DIR, "tmp"), 0755, true, cb);
  fs.mkdir(path.join(GLOBAL.DATA_DIR, "channels"), 0755, true, cb);
  fs.mkdir(path.join(GLOBAL.DATA_DIR, "cdn/img/av"), 0755, true, cb);
  fs.mkdir(path.join(GLOBAL.DATA_DIR, "cdn/img/icofactory"), 0755, true, cb);
  fs.mkdir(path.join(GLOBAL.DATA_DIR, "cdn/img/pods"), 0755, true, cb);
}
